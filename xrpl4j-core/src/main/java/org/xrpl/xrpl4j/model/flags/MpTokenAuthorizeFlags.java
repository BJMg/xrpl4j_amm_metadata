...
public class MpTokenAuthorizeFlags extends TransactionFlags {
  ...
  /**
   * Constant {@link MpTokenAuthorizeFlags} for the {@code tfMPTUnauthorize} flag.
   */
  ...
  /**
   * Construct an empty instance of {@link MpTokenAuthorizeFlags}.
   *
   ...
   * which will be deleted as a result. If the holder's MPToken has non-zero balance while trying to set this flag,
